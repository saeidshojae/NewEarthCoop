...
const manageCount = {
    {
        $groupSetting ? $groupSetting - > manager_count : 0
    }
};
const inspectorCount = {
    {
        $groupSetting ? $groupSetting - > inspector_count : 0
    }
};
</script>
            ...
            <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-3 justify-start lg:justify-end">
                    ...
                    <button type="button" id="manage-members-btn"
                        ...
                        onclick="if(typeof window.showManageMembersModal === 'function') { window.showManageMembersModal(); } else { alert('تابع مدیریت اعضا یافت نشد. لطفاً صفحه را رفرش کنید.'); }">
                    ...
                    <button type="button" id="manage-reports-btn"
                        ...
                        onclick="if(typeof window.showManageReportsModal === 'function') { window.showManageReportsModal(); } else { alert('تابع مدیریت گزارش‌ها یافت نشد. لطفاً صفحه را رفرش کنید.'); }">
                ...
                <form id="chatForm" class="chat-input telegram-style-input" method="POST"
                    ...
                    <div class="telegram-input-container">
                        ...
                        <div class="telegram-action-buttons">
                            <button type="submit" class="telegram-action-btn telegram-send-btn" title="ارسال">
  ...
  ">
    ...
    function addMessageToChat(messageData) {
        try {
            ...
            const isMine = messageData.user_id == {
                {
                    auth() - > id()
                }
            };
    ...
    function initScrollRestore() {
        ...
        if ('MutationObserver' in window) {
            const observer = new MutationObserver(function(mutations) {
                ...
                if (!scrollRestored && !window.scrollPositionRestored && chatBox && chatBox.scrollHeight >
