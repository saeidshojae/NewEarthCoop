...
<head>
    ...
    <title>خطای سرور - EarthCoop</title>
        ...
        <div class="container mx-auto max-w-2xl">
            <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center fade-in">
                ...
                <div class="mb-6 flex justify-center">
                    <div class="w-24 h-24 rounded-full flex items-center justify-center pulse-animation" style="background-color: #fee2e2;">
                        <i class="fas fa-exclamation-triangle text-5xl" style="color: #ef4444;"></i>
                    </div>
                </div>
                ...
                <p class="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
                    متأسفانه خطایی در سرور رخ داده است. تیم فنی ما در حال بررسی مشکل است. لطفاً چند لحظه صبر کنید و دوباره تلاش کنید.
                </p>
                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-8 text-right">
                    ...
                    <ul class="space-y-3 text-gray-700">
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-check-circle mt-1 ml-3" style="color: #10b981;"></i>
                            <span>به <strong>صفحه اصلی</strong> برگردید</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle mt-1 ml-3" style="color: #10b981;"></i>
                            <span>اگر مشکل ادامه داشت، با <strong>پشتیبانی</strong> تماس بگیرید</span>
                        </li>
                    </ul>
                </div>
