...
return new class extends Migration
{
    ...
    public function up()
    {
        // حذف جدول NajmBaharNotificationSetting چون همه داده‌ها به NotificationSetting منتقل شدند
    ...
    {
        // اگر نیاز به rollback بود، می‌توانید جدول را دوباره ایجاد کنید
        // اما داده‌های قدیمی از بین رفته‌اند
