...
@section('title', 'ایجاد مقاله جدید - ' . config('app.name', 'EarthCoop'))
@section('page-title', 'ایجاد مقاله جدید')
                ...
                <div class="blog-form-card">
                    ...
                    <div class="blog-form-group">
                        ...
                        <textarea class="blog-form-textarea" 
                                  ...
                                  name="excerpt" 
                                  rows="3"
                                  placeholder="خلاصه کوتاهی از مقاله را وارد کنید">{{ old('excerpt') }}</textarea>
                        </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="blog-form-card">
                    ...
                    <div class="blog-form-group">
                        ...
                        <div class="blog-form-help">خالی = همین الان</div>
                        </div>
                ...
                <!-- Submit Button -->
                <div class="blog-form-card">
                    <button type="submit" class="blog-form-submit w-full justify-center">
