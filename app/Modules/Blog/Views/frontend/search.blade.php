...
@section('title', 'جستجو: ' . ($query ?? '') . ' - ' . config('app.name', 'EarthCoop'))
    ...
    <div class="search-hero-content">
        <div class="container mx-auto px-6">
            <h1>
                ...
                نتایج جستجو
                @if($query)
                    برای: <span class="search-query">"{{ $query }}"</span>
                @endif
            </h1>
            <p>نتایج جستجوی شما در مقالات و مطالب بلاگ</p>
        </div>
    </div>
</section>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3">
            ...
            <div class="results-count">
                ...
                <p>نتایج جستجو برای: <strong>"{{ $query }}"</strong></p>
            </div>
            @endif
            ...
            <div class="empty-state">
                ...
                <p>متأسفانه هیچ مقاله‌ای با این کلمه کلیدی یافت نشد.</p>
                <a href="{{ route('blog.index') }}" class="search-btn" style="display: inline-block; text-decoration: none;">
