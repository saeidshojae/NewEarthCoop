...
@section('title', 'برچسب: ' . $tag->name . ' - ' . config('app.name', 'EarthCoop'))
...
<div class="container mx-auto px-6 py-8" style="direction: rtl;">
    ...
    <div class="tag-header">
        ...
        <p>{{ $posts->total() }} مقاله با این برچسب</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="blog-card-content">
                        ...
                        <div class="blog-tags">
                            ...
                            <a href="{{ route('blog.tag', $postTag->slug) }}" 
                               class="blog-tag {{ $postTag->id == $tag->id ? 'active' : '' }}">
                                #{{ $postTag->name }}
                            </a>
                            @endforeach
                        </div>
                ...
                <div class="col-span-2">
                    <div class="empty-state">
                        ...
                        <p class="empty-state-message">هیچ مقاله‌ای با این برچسب یافت نشد.</p>
                    </div>
                </div>
                @endforelse
            </div>
        ...
        <div class="lg:col-span-1">
            ...
            <div class="sidebar-card">
                ...
                <a href="{{ route('blog.category', $category->slug) }}" class="category-item">
                    ...
                    <span class="category-count">{{ $category->publishedPostsCount() }}</span>
                </a>
                @endforeach
            </div>
            ...
            <div class="sidebar-card">
                ...
                <div class="tag-cloud">
                    ...
                    <a href="{{ route('blog.tag', $otherTag->slug) }}" 
                       class="tag-cloud-item {{ $otherTag->id == $tag->id ? 'active' : '' }}">
                        #{{ $otherTag->name }}
                    </a>
                    @endforeach
                </div>
